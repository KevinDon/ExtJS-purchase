...
import com.newaim.purchase.archives.flow.shipping.service.OrderShippingApplyDetailService;
...
@RestController
@RequestMapping("/shipping/orderShippingApplyDetail")
public class OrderShippingApplyDetailController extends ControllerBase {
    ...
    public RestResult list(ServletRequest request, String sort, String keywords,
        ...
        try {
            ...
            Page<OrderShippingApplyDetailVo> page = orderShippingApplyDetailService.list(params, pageNumber, pageSize, getSort(sort));

...
public class FeeRegisterVo implements Serializable{
    ...
    private List<FeeRegisterDetailVo> details = Lists.newArrayList();
    private List<FeeRegisterDetailVo> otherDetails = Lists.newArrayList();
    ...
    public List<FeeRegisterDetailVo> getDetails() {
        return details;
    }

    public void setDetails(List<FeeRegisterDetailVo> details) {
    ...
    public List<FeeRegisterDetailVo> getOtherDetails() {
        return otherDetails;
    }

    public void setOtherDetails(List<FeeRegisterDetailVo> otherDetails) {

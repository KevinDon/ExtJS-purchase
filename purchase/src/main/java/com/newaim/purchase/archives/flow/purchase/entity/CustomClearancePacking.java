...
@Entity
@Table(name = "na_custom_clearance_packing")
public class CustomClearancePacking implements Serializable {

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "CCP")})
    private String id;

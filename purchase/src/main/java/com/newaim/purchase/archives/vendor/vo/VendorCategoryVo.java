...
public class VendorCategoryVo implements Serializable{
	...
	private List<VendorCategoryVo> children = Lists.newArrayList();
	...
	public List<VendorCategoryVo> getChildren() {
		return children;
	}

	public void setChildren(List<VendorCategoryVo> children) {

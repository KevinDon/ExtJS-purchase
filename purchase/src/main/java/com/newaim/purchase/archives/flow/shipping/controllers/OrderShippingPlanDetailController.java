...
@RestController
@RequestMapping("/shipping/orderShippingPlanDetail")
public class OrderShippingPlanDetailController extends ControllerBase {
    ...
    public RestResult list(ServletRequest request, String sort, String keywords,
        ...
        try {
            ...
            Page<OrderShippingPlanDetailVo> page = orderShippingPlanDetailService.list(params, pageNumber, pageSize, getSort(sort));

...
@Entity
@Table(name = "na_product_certification_apply")
public class ProductCertificationApply implements BusinessObject, Serializable {

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "PCA")})
    private String id;
    ...
    /**产品证书ID*/
    private String productCertificateId;

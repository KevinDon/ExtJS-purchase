...
public class TroubleTicketVo implements Serializable{
    ...
    private List<TroubleTicketProductVo> details = Lists.newArrayList();

    private List<TroubleTicketRemarkVo> comments = Lists.newArrayList();
    ...
    public List<TroubleTicketProductVo> getDetails() {
        return details;
    }

    public void setDetails(List<TroubleTicketProductVo> details) {
        this.details = details;
    }

    public List<TroubleTicketRemarkVo> getComments() {
        return comments;
    }

    public void setComments(List<TroubleTicketRemarkVo> comments) {

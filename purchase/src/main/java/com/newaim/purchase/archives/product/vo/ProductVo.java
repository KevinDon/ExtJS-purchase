...
/**
 * Created by Lance at 2017/10/28.
 */
public class ProductVo implements Serializable{
    ...
    private ProductVendorPropVo prop;
    ...
    /**历史报价*/
    private List<ProductQuotationVo> quotations = Lists.newArrayList();
    /**相关报告*/
    ...
    public ProductVendorPropVo getProp() {
        return prop;
    }

    public void setProp(ProductVendorPropVo prop) {
        this.prop = prop;
    }
    ...
    public List<ProductQuotationVo> getQuotations() {
        return quotations;
    }

    public void setQuotations(List<ProductQuotationVo> quotations) {

...
@Entity
@Table(name = "na_balance_refund")
public class BalanceRefund implements BusinessObject, Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "BR")})
    private String id;

...
public class CostVo implements Serializable{
    ...
    private List<CostOrderVo> costOrders = Lists.newArrayList();
    private List<CostProductVo> costProducts = Lists.newArrayList();

    private List<CostPortVo> costPorts = Lists.newArrayList();

    private List<CostChargeItemVo> costChargeItems = Lists.newArrayList();

    private List<CostTariffVo> costTariffs = Lists.newArrayList();

    private List<CostProductCostVo> costProductCosts = Lists.newArrayList();
    ...
    public List<CostOrderVo> getCostOrders() {
        return costOrders;
    }

    public void setCostOrders(List<CostOrderVo> costOrders) {
    ...
    public List<CostPortVo> getCostPorts() {
        return costPorts;
    }

    public void setCostPorts(List<CostPortVo> costPorts) {
    ...
    public List<CostTariffVo> getCostTariffs() {
        return costTariffs;
    }

    public void setCostTariffs(List<CostTariffVo> costTariffs) {
        this.costTariffs = costTariffs;
    }

    public List<CostProductCostVo> getCostProductCosts() {
    ...
    public void setCostProductCosts(List<CostProductCostVo> costProductCosts) {

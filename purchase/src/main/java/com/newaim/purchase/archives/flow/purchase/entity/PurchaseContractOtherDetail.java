...
@Entity
@Table(name = "na_purchase_contract_other_detail")
public class PurchaseContractOtherDetail implements Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "PCOD")})
    private String id;

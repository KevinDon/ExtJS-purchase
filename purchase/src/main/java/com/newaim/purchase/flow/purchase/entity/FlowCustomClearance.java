...
@Entity
@Table(name = "na_flow_custom_clearance")
public class FlowCustomClearance implements FlowObject, Serializable {

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FCC")})
    private String id;

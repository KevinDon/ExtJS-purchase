...
public class FlowOrderQcVo implements Serializable{
    ...
    private List<FlowOrderQcDetailVo> details = Lists.newArrayList();

    private List<AttachmentVo> attachments = Lists.newArrayList();//附件表信息

    private List<ReportsVo> reports = Lists.newArrayList();//附件表信息
    ...
    public List<FlowOrderQcDetailVo> getDetails() {
        return details;
    }

    public void setDetails(List<FlowOrderQcDetailVo> details) {

...
@Entity
@Table(name = "na_flow_order_qc")
public class FlowOrderQc implements FlowVendorObject, Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FOQ")})
    private String id;

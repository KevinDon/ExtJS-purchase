...
@Entity
@Table(name = "na_flow_sample_qc")
public class FlowSampleQc implements FlowVendorObject, Serializable {

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FSQ")})
    private String id;
    /**申请时间*/

...
public class FlowOrderShippingPlanVo implements Serializable{
    ...
    private List<FlowOrderShippingPlanDetailVo> details = Lists.newArrayList();
    ...
    private List<ServiceProviderQuotationVo> quotations = Lists.newArrayList();
    /**挂起状态*/
    ...
    public List<FlowOrderShippingPlanDetailVo> getDetails() {
        return details;
    }

    public void setDetails(List<FlowOrderShippingPlanDetailVo> details) {
    ...
    public List<ServiceProviderQuotationVo> getQuotations() {
        return quotations;
    }

    public void setQuotations(List<ServiceProviderQuotationVo> quotations) {

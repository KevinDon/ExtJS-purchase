...
public class FlowAsnPackingDetailVo implements Serializable{
    ...
    private CustomClearancePackingDetailVo ccPackingDetail;
    ...
    public CustomClearancePackingDetailVo getCcPackingDetail() {
        return ccPackingDetail;
    }

    public void setCcPackingDetail(CustomClearancePackingDetailVo ccPackingDetail) {
        this.ccPackingDetail = ccPackingDetail;
    }
}

...
@Entity
@Table(name = "na_flow_fee_payment")
//public class FlowFeePayment implements FlowObject, Serializable {
public class FlowFeePayment implements FlowVendorWithCurrencyObject, Serializable{
    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FFP")})
    private String id;

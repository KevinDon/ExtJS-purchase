...
public class FlowAsnVo implements Serializable{
    ...
    private List<FlowAsnPackingVo> details = Lists.newArrayList();
    ...
    public List<FlowAsnPackingVo> getDetails() {
        return details;
    }

    public void setDetails(List<FlowAsnPackingVo> details) {

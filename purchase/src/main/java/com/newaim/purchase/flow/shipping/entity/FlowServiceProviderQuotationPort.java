...
@Entity
@Table(name = "na_flow_service_provider_quotation_port")
public class FlowServiceProviderQuotationPort implements Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FSPQP")})
    private String id;

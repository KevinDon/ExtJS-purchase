...
@Entity
@Table(name = "na_flow_purchase_contract_other_detail")
public class FlowPurchaseContractOtherDetail implements Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FPOD")})
    private String id;

...
@Repository
public interface FlowServiceProviderQuotationPortDao extends JpaRepository<FlowServiceProviderQuotationPort, String>, JpaSpecificationExecutor<FlowServiceProviderQuotationPort> {
     ...
     * @return 明细集合
     */
    List<FlowServiceProviderQuotationPort> findPortsByBusinessId(String businessId);
    ...
    @Query(nativeQuery = true, value = "SELECT p.id,d.business_id,p.origin_port_id,p.origin_port_cn_name,p.origin_port_en_name,p.destination_port_id,p.destination_port_cn_name,p.destination_port_en_name,\n" +
            "  d.id as flow_order_shipping_plan_id,null as frequency, null as sailing_days,\n" +
            ...
            "  0 as price_gp20_insurance_aud,0 as price_gp20_insurance_rmb,0 as price_gp20_insurance_usd,\n" +
            "  0 as price_gp40_insurance_aud,0 as price_gp40_insurance_rmb,0 as price_gp40_insurance_usd,\n" +
            "  0 as price_hq40_insurance_aud,0 as price_hq40_insurance_rmb,0 as price_hq40_insurance_usd,\n" +
            "  0 as price_lcl_insurance_aud,0 as price_lcl_insurance_rmb,0 as price_lcl_insurance_usd,\n" +
            ...
            "  0 as prev_rate_aud_to_rmb,0 as prev_rate_aud_to_usd,null as prev_frequency, null as prev_sailing_days,\n" +
            ...
            "  0 as prev_price_gp20_insurance_aud,0 as prev_price_gp20_insurance_rmb,0 as prev_price_gp20_insurance_usd,\n" +
            "  0 as prev_price_gp40_insurance_aud,0 as prev_price_gp40_insurance_rmb,0 as prev_price_gp40_insurance_usd,\n" +
            "  0 as prev_price_hq40_insurance_aud,0 as prev_price_hq40_insurance_rmb,0 as prev_price_hq40_insurance_usd,\n" +
            "  0 as prev_price_lcl_insurance_aud,0 as prev_price_lcl_insurance_rmb,0 as prev_price_lcl_insurance_usd,\n" +
    ...
    List<FlowServiceProviderQuotationPort> findPortsForQuotation(@Param("serviceProviderId") String serviceProviderId, @Param("flowOrderShippingPlanId") String flowOrderShippingPlanId);
}

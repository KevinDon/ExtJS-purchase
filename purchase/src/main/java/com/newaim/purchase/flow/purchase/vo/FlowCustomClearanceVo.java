...
public class FlowCustomClearanceVo implements Serializable{
    ...
    /**关联详细表信息*/
    private List<FlowCustomClearancePackingVo> details = Lists.newArrayList();
    ...
    public List<FlowCustomClearancePackingVo> getDetails() {
        return details;
    }

    public void setDetails(List<FlowCustomClearancePackingVo> details) {

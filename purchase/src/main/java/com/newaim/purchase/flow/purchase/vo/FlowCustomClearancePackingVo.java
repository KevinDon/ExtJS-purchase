...
public class FlowCustomClearancePackingVo implements Serializable{
    ...
    /**关联详细表信息*/
    private List<FlowCustomClearancePackingDetailVo> packingList = Lists.newArrayList();
    ...
    public List<FlowCustomClearancePackingDetailVo> getPackingList() {
        return packingList;
    }

    public void setPackingList(List<FlowCustomClearancePackingDetailVo> packingList) {

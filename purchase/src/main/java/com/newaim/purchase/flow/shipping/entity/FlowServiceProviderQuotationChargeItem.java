...
@Entity
@Table(name = "na_flow_service_provider_quotation_charge_item")
public class FlowServiceProviderQuotationChargeItem implements Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FSPQC")})
    private String id;

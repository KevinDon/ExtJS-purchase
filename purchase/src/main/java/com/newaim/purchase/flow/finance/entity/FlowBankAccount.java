...
@Entity
@Table(name = "na_flow_bank_account")
public class FlowBankAccount implements FlowVendorObject, Serializable {

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FBA")})
    private String id;
    ...
    @Transient
    private String guaranteeLetterFile;//保函文件
    @Transient
    private String contractGuaranteeLetterFile;//合同担保函
    @Transient
    ...
    public String getGuaranteeLetterFile() {
        return guaranteeLetterFile;
    }

    public void setGuaranteeLetterFile(String guaranteeLetterFile) {
        this.guaranteeLetterFile = guaranteeLetterFile;
    }

    public String getContractGuaranteeLetterFile() {
        return contractGuaranteeLetterFile;
    }

    public void setContractGuaranteeLetterFile(String contractGuaranteeLetterFile) {

...
@Entity
@Table(name = "na_flow_order_shipping_plan_detail")
public class FlowOrderShippingPlanDetail implements Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FOSPD")})
    private String id;

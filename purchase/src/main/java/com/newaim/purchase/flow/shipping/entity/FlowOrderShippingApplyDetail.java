...
@Entity
@Table(name = "na_flow_order_shipping_apply_detail")
public class FlowOrderShippingApplyDetail implements Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FOSAD")})
    private String id;

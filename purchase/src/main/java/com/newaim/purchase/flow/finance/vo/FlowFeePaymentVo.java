...
public class FlowFeePaymentVo implements Serializable{
    ...
    private FlowFeeRegisterVo feeRegisterVo;

    private FlowFeeRegisterVo flowFeeRegisterVo;
    /**订单编码、订单标题*/
    ...
    public FlowFeeRegisterVo getFlowFeeRegisterVo() {
        return flowFeeRegisterVo;
    }

    public void setFlowFeeRegisterVo(FlowFeeRegisterVo flowFeeRegisterVo) {
        this.flowFeeRegisterVo = flowFeeRegisterVo;
    }

    public FlowFeeRegisterVo getFeeRegisterVo() {
        return feeRegisterVo;
    }

    public void setFeeRegisterVo(FlowFeeRegisterVo feeRegisterVo) {
        this.feeRegisterVo = feeRegisterVo;
    }
}

...
@Entity
@Table(name = "na_flow_warehouse_plan")
public class FlowWarehousePlan implements FlowServiceProviderObject, Serializable{

    @Id
    @GeneratedValue(generator = "idGenerator")
    @GenericGenerator(name = "idGenerator", strategy = "com.newaim.core.jpa.IdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(name = "prefix", value = "FWP")})
    private String id;

...
public class ServletUtils {
    ...
    /**
     * 取得带Q-前缀的Request Parameters, copy from spring WebUtils.
     *
     * 返回的结果的Parameter名已去除前缀.
     */
    public static LinkedHashMap<String, Object> getParametersStartingWith(ServletRequest request) {
        return getParametersStartingWith(request, "Q-");
    }
     ...
     * 返回的结果的Parameter名已去除前缀.
     */
    public static LinkedHashMap<String, Object> getParametersStartingWith(ServletRequest request, String prefix) {
    ...
    /**
     * 组合Parameters生成Query String的Parameter部分, 并在paramter name上加上前缀Q-.
     *
     * @see #getParametersStartingWith
     */
    public static String encodeParameterStringWithPrefix(Map<String, Object> params) {
        return encodeParameterStringWithPrefix(params, "Q-");
    }

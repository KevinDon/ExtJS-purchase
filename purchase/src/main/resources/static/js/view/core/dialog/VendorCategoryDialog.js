Ext.define('App.VendorCategoryDialog', {
    extend: 'Ext.form.field.Trigger',
    alias: 'widget.VendorCategoryDialog',

    constructor : function(conf) {
    	this.onlyRead = conf.readOnly || false;
    	this.listeners = {afterrender: function( e, eOpts ){e.setReadOnly(conf.readOnly);}};
    	App.VendorCategoryDialog.superclass.constructor.call(this, conf);
    },
...
VendorCategoryDialogWin = Ext.extend(HP.Window,{
    constructor : function(conf) {
        conf.title = _lang.VendorCategory.mTitle;
        conf.winId = 'VendorCategoryDialogWinID';
        conf.mainGridPanelID = 'VendorCategoryDialogWinGridPanelID';
        conf.selectGridPanelId = 'VendorCategoryDialogWinSelectGridPanelID';
        conf.treePanelId = 'VendorCategoryDialogWinTreePanelId';
        conf.urlList = __ctxPath + 'archives/vendor-category/listForDialog',
        ...
        VendorCategoryDialogWin.superclass.constructor.call(this, {
            id : conf.winId,
            scope : this,
            title : _lang.VendorCategory.mSelectorTitle,
        ...
        Ext.Ajax.request({
            ...
            success : function(response, options) {
                ...
                if(obj.success == true){
                    ...
                    var VendorCategoryDialogTreePanel = new Ext.tree.TreePanel({
                        id : conf.treePanelId,
                        layout : 'fit',
                        border : false,
                        autoScroll : true,
                        ...
                        lines:true,
                        columns: [
                            { text: curUserInfo.lang =='zh_CN'? _lang.VendorCategory.fCnName: _lang.VendorCategory.fEnName, dataIndex: 'name', xtype:'treecolumn', width:250},
                    ...
                    cmpPanel.add(VendorCategoryDialogTreePanel);
                    VendorCategoryDialogTreePanel.expandAll();

                    //初始化选择
                    this.selecteNodes(VendorCategoryDialogTreePanel.getRootNode().childNodes, this.selectedId);
                }else{
    ...
    initUI : function() {
        ...
        this.selectGridPanel = new HP.GridPanel({
            region : 'east',
            title: _lang.VendorCategory.mSelecttedCategory,
            ...
            columns : [
                ...
                { header: _lang.VendorCategory.tCategory, dataIndex: 'name', sortable:false},
            ],// end of columns
            itemdblclick : function(obj, record, item, index, e, eOpts){

Ext.define('App.ProductCertificateDocumentTabs', {
    extend: 'Ext.tab.Panel',
    alias: 'widget.ProductCertificateDocumentTabs',
    ...
    constructor : function(conf){
        ...
        conf.items[0] = new HP.GridPanel({
            id: conf.gridPanelId,
            title: _lang.ProductCertificateDocument.tabProductListTitle,
            collapsible: true,
            split: true,
            scope: this,
            forceFit: false,
        ...
        conf.items[0].doLayout();
        
        try {
            conf.items[1] = new App.ArchivesHistoryTabGrid({
                historyListUrl: 'archives/productCertificate/history',
                historyGetUrl: 'archives/productCertificate/historyget',
                historyConfirmUrl: 'archives/productCertificate/historyconfirm',
                historyDelUrl: 'archives/productCertificate/historydelete',
                mainGridPanelId: conf.mainGridPanelId,
                title: _lang.ArchivesHistory.mTitle,
                winForm: ProductCertificateDocumentForm,
                noTitle: true
            });
        }catch (e){
            console.log(e);
        ...
        try{
            App.ProductCertificateDocumentTabs.superclass.constructor.call(this, {

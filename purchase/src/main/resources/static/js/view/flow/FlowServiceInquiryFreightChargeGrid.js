Ext.define('App.FlowServiceInquiryFreightChargeGrid', {
    extend: 'Ext.Panel',
    alias: 'widget.FlowServiceInquiryFreightChargeGrid',
    ...
    constructor : function(conf){
        ...
        conf.mainGridPanelId = this.mainGridPanelId || this.frameId + '-FlowServiceInquiryFreightMultiGrid';
        conf.mainFormPanelId = this.mainFormPanelId || this.frameId + '-FlowServiceInquiryFreightMultiForm';
        conf.subGridPanelId = this.subGridPanelId || conf.mainGridPanelId +'-FlowServiceInquiryFreightMultiGridPanelID';
        conf.subFormPanelId = this.subFormPanelId || conf.mainGridPanelId +'-FlowServiceInquiryFreightMultiFormPanelID';
        conf.defHeight = this.height || 350;

        this.initUIComponents(conf);
        
        App.FlowServiceInquiryFreightChargeGrid.superclass.constructor.call(this, {
    	...
    	var tools = [
            {type: 'refresh', tooltip: _lang.FlowServiceInquiry.fCalculatedAmount, scope: this,
                handler: function (event, toolEl, panelHeader) {
                    this.scope.refershFun.call(this.scope.mainForm, conf);
                }
            },
        ...
        this.subGridPanel = new HP.GridPanel({
            ...
            columns: [
                ...
                { header: _lang.FlowServiceInquiry.fSailingDays, columns: [
                    { header: _lang.TText.fNew, dataIndex: 'sailingDays', width: 50,
                ...
                { header: _lang.FlowServiceInquiry.fFrequency, columns: [
                    {header: _lang.TText.fNew, dataIndex: 'frequency', width: 50,
                        renderer: function (value, meta, recode) {
                            meta.tdCls = 'grid-input';
                            return value
                        },

FlowSampleQcForm = Ext.extend(Ext.Panel, {
    ...
    constructor: function(conf) {
        ...
        var conf = {
            title : _lang.FlowSampleQc.mTitle + $getTitleSuffix(this.action),
            ...
            urlDirection: __ctxPath + 'flow/workflow/viewimage?processDefinitionKey=FlowSampleQc&processInstanceId=' + (this.isApprove? this.record.processInstanceId: ''),
        ...
        FlowSampleQcForm.superclass.constructor.call(this, {
    ...
    initUIComponents: function(conf) {
        ...
        this.editFormPanel = new HP.FormPanel({
            ...
            fieldItems : [
                ...
                { field: 'main.products', xtype: 'FlowSampleQcFormGrid', fieldLabel: _lang.FlowNewProduct.fProductList, scope:this, readOnly: this.readOnly},

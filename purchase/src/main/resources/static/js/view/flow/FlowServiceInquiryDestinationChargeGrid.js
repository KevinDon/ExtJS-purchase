Ext.define('App.FlowServiceInquiryDestinationChargeGrid', {
    extend: 'Ext.Panel',
    alias: 'widget.FlowServiceInquiryDestinationChargeGrid',
    ...
    constructor : function(conf){
        ...
        conf.mainGridPanelId = this.mainGridPanelId || this.frameId + '-FlowServiceInquiryMultiGrid';
        conf.mainFormPanelId = this.mainFormPanelId || this.frameId + '-FlowServiceInquiryMultiForm';
        conf.subGridPanelId = this.subGridPanelId || conf.mainGridPanelId +'-FlowServiceInquiryMultiGridPanelID';
        conf.subFormPanelId = this.subFormPanelId || conf.mainGridPanelId +'-FlowServiceInquiryMultiFormPanelID';
        conf.defHeight = this.height || 300;

        this.initUIComponents(conf);

        App.FlowServiceInquiryDestinationChargeGrid.superclass.constructor.call(this, {

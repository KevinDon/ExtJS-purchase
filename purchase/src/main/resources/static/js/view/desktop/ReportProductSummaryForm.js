ReportProductSummaryForm = Ext.extend(HP.Window, {
	constructor : function(_cfg) {
		...
		var conf = {
			title : _lang.ReportProductSummary.mTitle  + $getTitleSuffix(this.action),
			winId : 'ReportProductSummaryFormWinID',
		...
		ReportProductSummaryForm.superclass.constructor.call(this, {
			id : conf.winId,
			scope : this,
			title : conf.title,

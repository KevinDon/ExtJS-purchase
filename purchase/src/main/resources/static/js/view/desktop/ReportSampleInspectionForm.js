ReportSampleInspectionForm = Ext.extend(HP.Window, {
	constructor : function(_cfg) {
		...
		var conf = {
			title : _lang.ReportSampleInspection.mTitle + $getTitleSuffix(this.action),
			winId : 'ReportSampleInspectionFormWinID',
            moduleName: 'ReportSampleInspection',
            frameId : 'ReportSampleInspectionView',
            mainGridPanelId : 'ReportSampleInspectionGridPanelID',
            mainFormPanelId : 'ReportSampleInspectionFormPanelID-' + Ext.id(),
            mainViewPanelId : 'ReportSampleInspectionViewPanelID',
            formGridPanelId:'ReportSampleInspectionFormGridPanelID',
            searchFormPanelId: 'ReportSampleInspectionSearchPanelID',
            mainTabPanelId: 'ReportSampleInspectionTbsPanelId',
            subGridPanelId: 'ReportSampleInspectionSubGridPanelId',
            urlSave: __ctxPath + 'reportsampleinspection/save',
            urlGet: __ctxPath + 'reportsampleinspection/get',
        ...
        ReportSampleInspectionForm.superclass.constructor.call(this, {
			id : conf.winId,
			scope : this,
			title : conf.title,
            ...
            fieldItems: [
                ...
                { xtype: 'container', cls:'row',  items:[
                    ...
                    {field: 'main_businessId', xtype: 'FlowOtherDialog', fieldLabel: _lang.Reports.fBusinessId, hiddenName:'main.businessId',
                        cls:'col-2', allowBlank: false, frameId:conf.mainFormPanelId, single:true, readOnly: this.isReadOnly, displayType: 3,
                ...
                { xtype: 'container', cls:'row',  items:[
                    ...
                    {field: 'main.reportTime', xtype:'datetimefield', fieldLabel:_lang.Reports.fReportTime, format: curUserInfo.dateFormat, cls:'col-2', allowBlank: false, value:Ext.Date.format(new Date(), curUserInfo.dateFormat)},
			...
			this.editFormPanel.loadData({
				...
				preName : 'main', loadMask:true, success:function(response){
                    ...
                    if(json.data.reportFile) {
                        cmp.getCmpByName('reportFileDocumentName').setValue(json.data.reportFile.document.name);
                        cmp.getCmpByName('main.reportFile').setValue(json.data.reportFile.documentId);
                    }
                    ...
                    cmp.appDepId = json.data.departmentId || '';
    ...
    getAutoCode: function () {
        ...
        if(!!appDepId) {
            Ext.Ajax.request({
                url: __ctxPath + 'admin/autocode/generate?code=sample_inspection&departmentId=' + appDepId,

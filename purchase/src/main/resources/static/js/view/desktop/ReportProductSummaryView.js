ReportProductSummaryView = Ext.extend(Ext.Panel, {
	constructor: function(conf) {
		Ext.applyIf(this, conf);
		var conf = {
			title : _lang.ReportProductSummary.mTitle,
			moduleName: 'ReportProductSummary',
			frameId : 'ReportProductSummaryView',
			mainGridPanelId : 'ReportProductSummaryGridPanelID',
			mainFormPanelId : 'ReportProductSummaryFormPanelID',
			mainViewPanelId : 'ReportProductSummaryViewPanelID',
			searchFormPanelId: 'ReportProductSummarySearchPanelID',
			mainTabPanelId: 'ReportProductSummaryTbsPanelId',
			urlList: __ctxPath + 'reportproductsummary/list',
			urlSave: __ctxPath + 'reportproductsummary/save',
			urlDelete: __ctxPath + 'reportproductsummary/delete',
			urlGet: __ctxPath + 'reportproductsummary/get',
			refresh: true,
			add: true,
			copy: true,
			edit: true,
		...
		ReportProductSummaryView.superclass.constructor.call(this, {
	...
	initUIComponents: function(conf) {		
		...
		this.gridPanel = new HP.GridPanel({
			...
			title: _lang.ReportProductSummary.tabListTitle,
			collapsible: true,
			split: true,
			scope: this,
			forceFit: false,
...
//			scope: this,
    ...
    editRow: function(conf){
        new ReportProductSummaryForm(conf).show();
    }
});
Ext.define('App.ReportSampleInspectionFormGrid', {
    extend: 'Ext.Panel',
    alias: 'widget.ReportSampleInspectionFormGrid',
    ...
    constructor : function(conf){
        ...
        var conf = {
            ...
            formGridPanelId : this.formGridPanelId + Ext.id(),
        ...
        App.ReportSampleInspectionFormGrid.superclass.constructor.call(this, {
    ...
    initUIComponents: function(conf){
        ...
        this.formGridPanel.store.on('dataChanged', function (store) {
            if(!!conf.dataChangeCallback) {
                conf.dataChangeCallback.call(conf.scope, store);
            }
        });

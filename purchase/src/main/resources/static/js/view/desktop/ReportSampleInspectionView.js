ReportSampleInspectionView = Ext.extend(Ext.Panel, {
	constructor: function(conf) {
		Ext.applyIf(this, conf);
		var conf = {
			title : _lang.ReportSampleInspection.mTitle,
			...
			mainFormPanelId : 'ReportSampleInspectionFormPanelID',
			...
			urlList: __ctxPath + 'reportsampleinspection/list',
			urlSave: __ctxPath + 'reportsampleinspection/save',
			urlDelete: __ctxPath + 'reportsampleinspection/delete',
		...
		ReportSampleInspectionView.superclass.constructor.call(this, {
	...
	initUIComponents: function(conf) {		
		...
		this.gridPanel = new HP.GridPanel({
			...
			title: _lang.ReportSampleInspection.tabListTitle,
			collapsible: true,
			split: true,
			scope: this,
			forceFit: false,
...
//			scope: this,
    ...
    editRow: function(conf){
        new ReportSampleInspectionForm(conf).show();
    }
});
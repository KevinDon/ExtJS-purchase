ReportProductForecastView = Ext.extend(Ext.Panel, {
    constructor: function(conf) {
        Ext.applyIf(this, conf);
        var conf = {
            title : _lang.ReportProductForecast.mTitle,
            ...
            urlList: __ctxPath + 'reportproductforecast/list',
            urlSave: __ctxPath + 'reportproductforecast/save',
            urlDelete: __ctxPath + 'reportproductforecast/delete',
        ...
        ReportProductForecastView.superclass.constructor.call(this, {
    ...
    initUIComponents: function(conf) {
        ...
        this.gridPanel = new HP.GridPanel({
            ...
            title: _lang.ReportProductForecast.tabListTitle,
            collapsible: true,
            split: true,
            scope: this,
            forceFit: false,
...
//			scope: this,
    ...
    editRow: function(conf){
        new ReportProductForecastForm(conf).show();
    }
});
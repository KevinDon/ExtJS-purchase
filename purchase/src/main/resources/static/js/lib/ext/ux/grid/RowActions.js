...
Ext.define('Ext.ux.grid.RowActions',{
	...
	,tplRow:
		...
		+'<tpl for="actions">'
		+'<div class="ux-row-action-item {cls} <tpl if="text">ux-row-action-text</tpl>" '
		+'style="{hide}{style}" data-qtip="{qtip}">'
		+'<tpl if="btnCls"><button class="x-btn"><span class="x-btn-wrap"><span data-qtip="{qtip}" class="x-btn-button"><span class="x-btn-inner x-btn-inner-center fa fa-fw {btnCls}"><tpl if="btnText"> {btnText}</tpl></span></span></span></button></tpl>'
		+'<tpl if="text"><span data-qtip="{qtip}" class="fa fa-fw">{text}</span></tpl>'
		+'</div></tpl>'
		+'</div>'
...
//		me.grid.on('destroy', me.purgeListeners, me);
	...
	,processActions:function(actions, template) {
		...
		Ext.each(actions, function(a, i) {
			...
			me.callbacks['scope'] = me.scope || {};

			// data for intermediate template
			var o = {
				 cls:a.iconIndex ? '{' + a.iconIndex + '}' : (a.iconCls ? a.iconCls : '')
				,qtip:a.qtipIndex ? '{' + a.qtipIndex + '}' : (a.tooltip || a.qtip ? a.tooltip || a.qtip : '')
			    ,btnCls:a.btnClsIndex ? '{' + a.btnClsIndex + '}' : (a.btnCls ? a.btnCls : '')
			    ,btnText:a.btnTextIndex ? '{' + a.btnTextIndex + '}' : (a.btnText ? a.btnText : '')
